...
$ sudo apt-key adv --keyserver keyserver.ubuntu.com --recv-keys A8D3785C $ sudo apt update $ sudo apt install -f mysql-client=5.7* mysql-community-server=5.7* mysql-server=5.7*
